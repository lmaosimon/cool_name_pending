...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
    @user = User.new(name: "Example User", email: "user.144@osu.edu", password: "foobar", password_confirmation: "foobar",
                      status: "student");
  end
  ...
  test "email validation should accept valid addresses" do
    valid_addresses = %w[user.29@osu.edu USER.35@osu.edu user.47@OSU.edu user.19@osu.EDU user.98@OSU.EDU];
